		...
		<div class="wrap_box use_your_illusion" id="nav_box">
			<div class="container">
				<div class="grid_40" id="nav">
					...
					<ul>
						<li><a href="/git/haranblog" <?php if($active): ?>class="active"<?php endif; ?>>首页</a></li>
						<li><a href="<?php echo U('Home/Article/index');?>" <?php if($active): ?>class="active"<?php endif; ?>>文章</a></li>
						<li><a href="<?php echo U('Home/Category/index');?>" <?php if($active): ?>class="active"<?php endif; ?>>分类</a></li>
						<li><a href="<?php echo U('Home/About/index');?>" <?php if($active): ?>class="active"<?php endif; ?>>关于</a></li>
						<li><a href="<?php echo U('Home/Contact/index');?>" <?php if($active): ?>class="active"<?php endif; ?>>联系</a></li>
					</ul>
				</div>
			</div>
		</div>
